...
namespace ORB_SLAM3 {
    ...
    private:
        ...
        int sensor_ = 0;
        CameraType cameraType_ = CameraType::PinHole;

        /*
         * Visual stuff
         */
        GeometricCamera* calibration1_ = nullptr, *calibration2_ = nullptr;
        ...
        int nLevels_ = 0;
        int initThFAST_ = 0, minThFAST_ = 0;

        /*
         * Viewer stuff
         */
        float keyFrameSize_ = 0.f;
        float keyFrameLineWidth_ = 0.f;
        float graphLineWidth_ = 0.f;
        float pointSize_ = 0.f;
        float cameraSize_ = 0.f;
        float cameraLineWidth_ = 0.f;
        float viewPointX_ = 0.f, viewPointY_ = 0.f, viewPointZ_ = 0.f, viewPointF_ = 0.f;
        float imageViewerScale_ = 0.f;
